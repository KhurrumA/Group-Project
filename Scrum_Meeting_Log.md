...
- **Manpreet Kaur:**
  - Working on a basic structure of the user and admin and upload, and continue to work on the courses page, that Favour worked on too.
- **David Sarkodie Junior:**
  - Adding on a friends & leaderboard section. 
- **Mahirul Islam:**
  - Adding on a course stats page and a improvement page and improving the leaderboard section, friends section that David worked on and improving the top courses section.
- **Khurrum Arif:**
  - Working on the badges html page to change it to a pug file and improving it and adding a review.pug file.
- **Zainab Patel:**
  - Continuing working on the basic structure that Taran is working on so Zainab is working on to start the leaderboards, friends and the comments page as Mahirul will work on that section by making changes to the basic structure for the admin.
- **Taran Singh:** 
  - Working on a basic structure for the user profile push that Zainab will continue to work on. Taran is also working on the ranking page and the add friend page.
- **Maclain Apsley-Turner:**
  -  Helping Zainab with the admin page to edit comments on the courses page to review courses and to remove reviews.
- **Favour Cole:**
  - Working on the dashboard by adding a new container for only top 3 courses on the courses page.
