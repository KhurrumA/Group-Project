...
exports.start = exports.reviews = exports.logout = exports.login = exports.complete = void 0;
...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
    var res, userRole, dashboardPath;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          if (res.data.status === "success") {
            ...
            dashboardPath = userRole === "admin" ? "/admin-dashboard" : "/dashboard"; //get the correct dashboard based on the user role
...
var reviews = exports.reviews = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(review, rating, courseId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://localhost:3000/v1/reviews/".concat(courseId),
            data: {
              review: review,
              rating: rating,
              courseId: courseId
        ...
        case 5:
          res = _context3.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Thanks for your review");
            window.setTimeout(function () {
        ...
        case 9:
          ...
          (0, _alerts.showAlert)("error", "You cannot review a course twice!");
          window.setTimeout(function () {
            location.assign("/dashboard");
          }, 1000); //take 1.5 sec to load the home page
        case 13:
  ...
  return function reviews(_x3, _x4, _x5) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://localhost:3000/v1/courses/start/".concat(courseId),
            data: {
              courseId: courseId
            }
          });
...
// FINISH COURSE
var complete = exports.complete = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(courseId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: "http://localhost:3000/v1/courses/complete/".concat(courseId),
            data: {
              courseId: courseId
            }
          });
        case 5:
          res = _context5.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "You have completed your course");
            window.setTimeout(function () {
              location.assign("/dashboard");
...
exports.signup = exports.enroll = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, password, cpassword) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 9:
          _context.prev = 9;
          _context.t0 = _context["catch"](1);
          console.log("i am err", _context.t0);
          (0, _alerts.showAlert)("error", "Email already in use!");
        case 13:
        case "end":
          return _context.stop();
      }
...
//ENROLLING THE USER
var enroll = exports.enroll = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://localhost:3000/v1/users/enrollMe/".concat(courseId)
          });
        case 5:
          res = _context2.sent;
          if (res.data.status === "success") {
            console.log("Enrollment completed");
            (0, _alerts.showAlert)("success", "Enrollment completed");
            window.setTimeout(function () {
              location.assign("/dashboard");
            }, 1000); //take 1.5 sec to load the home page
          }
        ...
        case 9:
          _context2.prev = 9;
          _context2.t0 = _context2["catch"](1);
          (0, _alerts.showAlert)("error", "You are already enrolled!");
          window.setTimeout(function () {
            location.assign("/dashboard");
          }, 1000); //take 1.5 sec to load the home page
        case 13:
  ...
  return function enroll(_x5) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"userAccount.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)("error", "This is not an image file.");
        case 11:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"adminAccount.js":[function(require,module,exports) {
"use strict";
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* easlint-disable */
//tyoe is either password or data
var deleteReviews = exports.deleteReviews = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "DELETE",
            url: "http://localhost:3000/v1/reviews/".concat(reviewId)
          });
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
  ...
  return function deleteReviews(_x) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addFriend.js":[function(require,module,exports) {
"use strict";
...
var addFriend = exports.addFriend = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(friendId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: "http://localhost:3000/v1/users/addFriend/".concat(friendId)
          });
        case 3:
          res = _context.sent;
          console.log(res);
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Friend added successfully");
        ...
        case 9:
          ...
          (0, _alerts.showAlert)("error", "Error adding friend: " + _context.t0.message);
        case 13:
        case "end":
          return _context.stop();
      }
...
var _adminAccount = require("./adminAccount");
...
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; } /* easlint-disable */ //console.log('Hello from parcel ');
//DOM ELEMENTS
console.log("i am in index");
var loginForm = document.querySelector(".form--login");
var logoutBtn = document.querySelector(".nav__el--logout");
var signupForm = document.querySelector(".form--signup");
var enrollMe = document.querySelector(".enroll__btn");
var reviewForm = document.querySelector(".review-form");
var finishCourse = document.querySelector(".finish");
var startCourse = document.querySelectorAll(".startCourse");
var uploadPhoto = document.querySelector(".form-user-data");
var deleteReview = document.querySelectorAll(".delete_btns");
var friend = document.querySelector(".addFriend");
...
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    if (password.value !== cpassword.value) {
      ...
      (0, _register.signup)(name, email, password.value, cpassword.value);
    }
  });
}
...
if (reviewForm) {
  reviewForm.addEventListener("submit", function (e) {
    ...
    var selectedRating = document.querySelector('input[name="rate"]:checked').value;
    var courseId = submit.dataset.courseId;
    (0, _login.reviews)(review, selectedRating, courseId);
  });
}
...
if (finishCourse) {
  ...
  finishCourse.addEventListener("click", function () {
    var courseId = finishCourse.dataset.courseId;
    console.log(courseId); // Output: 5c88fa8cf4afda39709c2955
    (0, _login.complete)(courseId);
  });
}

//START COURSE
if (startCourse) {
  var _iterator = _createForOfIteratorHelper(startCourse),
    _step;
  try {
...
if (uploadPhoto) {
  ...
  uploadPhoto.addEventListener("submit", function (e) {
    e.preventDefault();
    ...
    console.log(form);
    (0, _userAccount.updateSettings)(form, "photo");
  });
}
document.addEventListener("DOMContentLoaded", function () {
  // Select the button using a more specific selector if necessary
  var okButton = document.querySelector(".alertb .btn");
...
if (friend) {
  friend.addEventListener("click", function () {
    var userId = friend.dataset.userId;
    (0, _addFriend.addFriend)(userId);
  });
}
...
//Delete reviews
if (deleteReview) {
  var _iterator2 = _createForOfIteratorHelper(deleteReview),
    _step2;
  try {
    var _loop2 = function _loop2() {
      ...
      btn.addEventListener("click", function () {
        ...
        (0, _adminAccount.deleteReviews)(reviewId);
      });
    };
